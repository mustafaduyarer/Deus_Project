...
formatter.step({
  "name": "user Verify the Check-in date on the left is 1 \"Thursday\", \"December\" 1, 2022 of next month",
  "keyword": "Then "
});
formatter.match({
...
formatter.step({
  "name": "user Verify the Check-out date on the left is 7 \"Wednesday\", \"December\" 7, 2022 of next month",
  "keyword": "Then "
});
formatter.match({
